...
from UnitConnection import UnitConnection
...
class XbeeListener(Thread):
    def run(self):
        ...
        while True:
            ...
            communicator = XbeeConnectionInit.get()
            ...
            if len(xbeeMessage) == 9:
                ...
                if check_message_emergency(self, xbeeMessage) is True:
                    ...
                    unitMessager = UnitConnection("0", xbeeMessage, "0")
                    ...
                    unitConnection = UnitConnection("0", xbeeMessage, "0")
